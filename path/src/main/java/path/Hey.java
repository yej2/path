 ...
 * @ResponseBody
 * 
 * @RequestMapping(value = "/rtInfomartion", method = RequestMethod.GET,
 * produces = "application/text; charset=utf8")
 * 
 * public String rtInfomartion(Locale locale, Model model) throws IOException{
 * 
 * StringBuilder urlBuilder = new
 * StringBuilder("http://ws.bus.go.kr/api/rest/buspos/getLowBusPosByRtid");
 * 
 * 
 * 
 ...
 * URLEncoder.encode("100100118", "UTF-8"));
 * 
